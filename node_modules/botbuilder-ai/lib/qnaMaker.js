...
const generateAnswerUtils_1 = require("./qnamaker-utils/generateAnswerUtils");
const activeLearningUtils_1 = require("./qnamaker-utils/activeLearningUtils");
const trainUtils_1 = require("./qnamaker-utils/trainUtils");
...
class QnAMaker {
    ...
    constructor(endpoint, options = {}, telemetryClient, logPersonalInformation) {
        ...
        this.generateAnswerUtils = new generateAnswerUtils_1.GenerateAnswerUtils(this._options, this.endpoint);
        this.trainUtils = new trainUtils_1.TrainUtils(this.endpoint);
    ...
    getAnswers(context, options, telemetryProperties, telemetryMetrics) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var response = yield this.getAnswersRaw(context, options, telemetryProperties, telemetryMetrics);
            if (!response) {
                return [];
            }
    ...
    getAnswersRaw(context, options, telemetryProperties, telemetryMetrics) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (question.length > 0) {
                ...
                const sortedQnaAnswers = generateAnswerUtils_1.GenerateAnswerUtils.sortAnswersWithinThreshold(result.answers, queryOptions);
            ...
            yield this.generateAnswerUtils.emitTraceInfo(context, queryResult, queryOptions);
            const qnaResponse = {
    ...
    generateAnswer(question, top, scoreThreshold) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (trimmedAnswer.length > 0) {
                ...
                return result.answers.filter((ans) => ans.score >= minScore)
    ...
    getLowScoreVariation(queryResult) {
        return activeLearningUtils_1.ActiveLearningUtils.getLowScoreVariation(queryResult);
    }
    /**
    ...
    callTrainAsync(feedbackRecords) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.trainUtils.callTrainAsync(feedbackRecords);
        });
    }
    /**
